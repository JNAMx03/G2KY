...
export default function StartScreen({ onStart }) {
  return (
    <div>
      <h1 className="text-2xl font-semibold text-center">G2KY ✨ — Descubre tu vibra</h1>
      <p className="text-sm text-center text-gray-500 mt-2">11 preguntas rápidas — menos de un minuto.</p>
      <div className="mt-6">
